...
namespace TrilhaApiDesafio.Controllers
{
    ...
    public class TarefaController : ControllerBase
    {
        ...
        public IActionResult ObterPorId(int id)
        {
            ...
            var tarefaPorId = _context.Tarefas.FirstOrDefault(x => x.Id == id);
        ...
        public IActionResult ObterTodos()
        {
            ...
            {
                // Se não houver tarefas, retornar NotFound
                return NotFound();
            }

            // Se houver tarefas, retornar OK com as tarefas encontradas
